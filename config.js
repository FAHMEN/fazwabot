...
global.config = {
    // Informasi bot dasar
    bot: {
        name: "Fazbot", // Nama bot
        prefix: /^[°•π÷×¶∆£¢€¥®™+✓_=|/~!?@#%^&.©^]/i, // Karakter awalan perintah yang diizinkan
        phoneNumber: "79269175361", // Nomor telepon bot (opsional jika menggunakan QR code)
        ...
        website: "https://relaxmusic.rf.gd" // Website untuk WhatsApp bot
    },
    ...
    msg: {
        ...
        footer: italic("Developed by fahril"), // Footer di pesan bot
    ...
    // Informasi owner bot
    owner: {
        name: "fazbot", // Nama owner bot
        number: "6285876902820", // Nomor telepon owner bot
        organization: "fahmen", // Nama organisasi owner bot
        co: [""] // Nomor co-owner bot
    },

    // Konfigurasi stiker bot
    sticker: {
        packname: "Stiker ini dibuat oleh fazbot:+79269175361", // Nama paket stiker
        author: "@fazbot-wabot" // Pembuat stiker
    },
